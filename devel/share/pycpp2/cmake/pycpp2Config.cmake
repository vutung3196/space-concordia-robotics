...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pycpp2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tungvu/concordia/space-concordia/robotics/test/space-concordia-robotics/src/pycpp2/${idir}'.  ${_report}")
    endif()
